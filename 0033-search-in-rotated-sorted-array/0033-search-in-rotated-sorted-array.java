...
//             int mid=lo+(hi-lo)/2;
//             if(nums[mid]==target) return mid;
//             else if(nums[mid]<=nums[hi])// i am in right sorted array (mid to high everthing is sorted)
//             {
//                 if((target>=nums[mid])&&(target<=nums[hi])) lo=mid+1;
//                 else hi=mid-1;
//             }
//             else if(nums[mid]>nums[hi])// i am in left sorted array (low to mid everthing is sorted)
//             {
